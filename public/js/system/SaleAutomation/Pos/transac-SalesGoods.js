...
function setTransac() {
    ...
    _t.htmlControl = {
        ...
        genGrid: function () {
            ...
            var transac_d = "<div class='col-12 transacgrid_d' id='transac-body' style='padding:0px !important;'>";
            transac_d += "<table class='table'>";
                transac_d += "<thead class='thead-dark'>";
                    transac_d += "<tr>";
                        // transac_d += "<th scope='col' class='w_5'>#</th>";
                        transac_d += "<th class='w_60'>Product</th>";
                        transac_d += "<th class='w_10'>Quantity</th>";
                        transac_d += "<th class='w_10'>#</th>";
                        transac_d += "<th class='w_20'>Price</th>";
                    transac_d += "</tr>";
                transac_d += "</thead>";
